...
{
    /// purpose: to generate random numbers to populate the bingo card with, 
    /// then to get random numbers to call during the game.
    public class RNGType
    {
        private SelectedNumbersList SelectedNumbersListObj = new SelectedNumbersList();
        ...
        // Creates the next set of random values 
        public int getNextUniqueRandomValue(int minVal, int maxVal)
        {
            ...
            while (isUnique == false)
            {
                ...
                if (!Globals.selectedNumbersListObj.isUnique(rn))
                {
                    isUnique = true;
                    Globals.selectedNumbersListObj.recordCalledNumber(rn);
                } // end if
            } // end while                
            return rn;
